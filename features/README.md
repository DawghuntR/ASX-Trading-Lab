...
This directory contains EPIC-level feature documentation. Each feature is tracked as its own markdown file with a unique id.

## Active EPICs

- 001 - GitHub Pages Web App + Homelab Signal Platform (umbrella)
