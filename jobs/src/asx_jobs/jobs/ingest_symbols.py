...
ASX_300_SYMBOLS = [
    ...
    "ARG", "ASX", "AWC", "AZJ", "BAP", "BEN", "BFL", "BGA", "BHP", "BKL",
    "BKW", "BLD", "BOQ", "BPT", "BRG", "BSL", "BWP", "CAR", "CBA", "CCL",
    "CCP", "CGF", "CHC", "CHN", "CIA", "CIM", "CLW", "CMW", "CNU", "COH",
    "COL", "CPU", "CQR", "CSL", "CSR", "CTD", "CWY", "DEG", "DHG", "DMP",
    "DOW", "DRR", "DXS", "EBO", "EDV", "ELD", "EML", "EVN", "EVT", "FBU",
    "FLT", "FMG", "FPH", "GMG", "GNE", "GOZ", "GPT", "GQG", "HLS", "HMC",
    "HUB", "HVN", "IAG", "IEL", "IFL", "IGO", "ILU", "IMB", "INA", "IPL",
    "IRE", "JBH", "JHX", "KAR", "KGN", "KMD", "LFG", "LIC", "LLC", "LNK",
    "LOV", "LYC", "MAQ", "MEZ", "MFG", "MGR", "MIN", "MMS", "MPL", "MQG",
    "MRM", "MTS", "NAB", "NCM", "NEC", "NHF", "NIC", "NSR", "NST", "NUF",
    "NWL", "NXT", "OML", "ORA", "ORG", "ORI", "OZL", "PBH", "PDL", "PLS",
    "PME", "PMV", "PNI", "PNV", "PPT", "PRN", "PTM", "QAN", "QBE", "QUB",
    "REA", "REH", "RHC", "RIO", "RMD", "RRL", "RWC", "S32", "SBM", "SCG",
    "SCP", "SDF", "SEK", "SFR", "SGM", "SGP", "SGR", "SHL", "SIQ", "SKC",
    "SLC", "SLR", "SNZ", "SOL", "SPK", "SQ2", "SRV", "SSM", "STO", "STW",
    "SUL", "SUN", "SVW", "TAH", "TCL", "TLC", "TLS", "TNE", "TPG", "TWE",
    "TYR", "UMG", "URW", "VCX", "VEA", "VNT", "VUK", "WBC", "WEB", "WES",
    "WHC", "WOR", "WOW", "WPR", "WTC", "XRO", "YAL", "ZIP",
]
